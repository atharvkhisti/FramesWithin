...
import { Palette, Loader2, Mail, Lock, Eye, EyeOff, User, CheckCircle } from 'lucide-react'
        ...
        <Card className="w-full max-w-md text-center">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-4">
              Click the link in your email to confirm your account and start using FramesWithin.
            </p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full pl-10 pr-10 py-2 border border-border rounded-md bg-background focus:outline-none focus:ring-2 focus:ring-purple-500"
                />
                <button
                  type="button"
